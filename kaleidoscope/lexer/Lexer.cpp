...
// los métodos que se quieran llamar de la clase Reader se tienen que llamar
// como: reader-><nombre_método>
...
Token Lexer::getToken() {
  ...
  if (lastCharacter == ',') {
    return {TokenType::TOK_COMMA, std::string(1, lastCharacter)};
  }
